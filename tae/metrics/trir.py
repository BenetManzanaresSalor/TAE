...
from ..utils import DOC_ID_KEY, Document, MaskedDocument

# TRIR default settings
BACKGROUND_KNOWLEDGE_KEY = "background_knowledge" # For TRIR background knowledge dataframe
# Most of TRIR default settings are defined in the TRI class


#region TRIR metric class

class TRIR(MetricABC):
